              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    {skill.instructor_rating_count > 0 ? (
                      <>
                        ...
                        <span className="text-sm font-medium" style={{ color: 'var(--gray-600)' }}>
                          {Number(skill.instructor_rating).toFixed(1)}
                        </span>
                      </>
                    ) : (
                      <span className="text-sm font-medium" style={{ color: 'var(--gray-500)' }}>No ratings yet</span>
                    )}
                  </div>
                </div>
              </div>
